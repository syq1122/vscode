...
export class SimpleCommentEditor extends CodeEditorWidget {
	...
	constructor(
		...
		super(domElement, options, codeEditorWidgetOptions, instantiationService, codeEditorService, commandService, clipboardService, scopedContextKeyService, themeService, notificationService, accessibilityService, languageConfigurationService, languageFeaturesService);
